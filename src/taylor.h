...
/************************************************************************/
/* REGULAR RTBP EQUATIONS */
MY_FLOAT **taylor_coefficients_rtbp(MY_FLOAT t, MY_FLOAT *x, int order);

MY_FLOAT **taylor_coefficients_rtbpA(MY_FLOAT t, MY_FLOAT *x, int order, int reuse_last_computation);
int       taylor_step_rtbp(MY_FLOAT *ti, MY_FLOAT *x, int dir, int step_ctl,
...
MY_FLOAT **taylor_coefficients_rtbp_variationalsA(MY_FLOAT t, MY_FLOAT *x, int order, int reuse_last_computation);
int       taylor_step_rtbp_variationals(MY_FLOAT *ti, MY_FLOAT *x, int dir, int step_ctl,
                                        double log10abserr, double log10relerr,
                                        MY_FLOAT *endtime, MY_FLOAT *ht, int *order);
